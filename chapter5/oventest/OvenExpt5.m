...
xlabel(axes1, 'Thermocouple-Measured Temperature / Celcius');
grid on
hold off
...
hold on
plot(axes2, I1, [Hcon1 V1*1000 10000*V1./I1], 'x', 'MarkerSize',8)
plot(axes2, I2, [Hcon2 V2*1000 10000*V2./I2], 'o')
...
plot(axes2, [2:0.001:9], newy2+delta2, 'r:')
plot(axes2, [2:0.001:9], newy2-delta2, 'r:')
...
plot(axes2, [0:0.05:9], (newy3+delta3), 'g:')
plot(axes2, [0:0.05:9], (newy3-delta3), 'g:')
...
plot(axes2, [0:0.05:9], (newy4+delta4), 'b:')
plot(axes2, [0:0.05:9], (newy4-delta4), 'b:')
legend('Temperature/Celcius (10th Feb)','Voltage/mV (10th Feb)','Resistance/(10^{-4} Ohms) (10th Feb)', ...
  'Temperature/Celcius (22nd Feb)','Voltage/mV (22nd Feb)','Resistance/(10^{-4} Ohms) (22nd Feb)', 'Location','SE')
...
plot(axes2, [0:0.05:9], (newy4+delta4), 'b:')
plot(axes2, [0:0.05:9], (newy4-delta4), 'b:')
legend('Temperature/Celcius','Voltage/mV','Resistance/(10^{-4} Ohms)', ...
       'Location','SE')
% Note that the temperature uncertainty comes from the scatter only, in the
% pyrometer/thermocouple temperature conversion.
xlabel(axes2, 'Current / A');
